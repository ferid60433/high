                            ...
                            <div class="tab-pane fade show active" id="subject" role="tabpanel">
                                <div class="row m-b-lg">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Purchased By</label>
                                            <div class="col-sm-10">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text"><i class="fas fa-user"></i></div>
                                                    </div>
                                                    <select class="form-control" id="PurchasedBy" name="PurchasedBy">
                                                        <option>Select</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control date-picker" placeholder="Expire Date" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
