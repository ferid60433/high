							...
							<tbody>
								...
								foreach ($groups as $group) :  ?>
									<tr>
										...
										<td>
											<a class="btn btn-sm btn-outline-warning" title="Edit" href="<?= base_url("admin/oexams/groups/edit/" . simple_crypt($group->id)) ?>">
												<i class="fas fa-edit"></i>
											</a> |
											<a class="btn btn-sm btn-outline-danger" title="Delete" href="<?= base_url("admin/oexams/groups/delete") ?>"><i class="fas fa-trash"></i></a>
										</td>
									</tr>
								<?php $x++;
								endforeach; ?>
