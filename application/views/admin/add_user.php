                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Full Name" value="<?= set_value('name', '') ?>" name="name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control date-picker" placeholder="20/12/2012" name="dob">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
