            ...
            <ul class="accordion-menu">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="<?=base_url("admin/reports/meritstage")?>">Merit Stage Report</a></li>
                        ...
                        <li><a href="<?=base_url("admin/reports/progressive")?>">Progress Card Report</a></li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="<?=base_url("admin/templates/certificate")?>">Certificate Template</a></li>
                        ...
                        <li><a href="<?=base_url("admin/templates/mails")?>">Mail/SMS Template</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:void(0);">
