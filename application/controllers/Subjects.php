		...
		if( !empty( $id )){
			...
			if( $subjects ){
				...
				foreach( $subjects as $s ){
					...
					$edit_btn = '<a class="btn btn-sm btn-outline-warning" title="Edit" href="'. base_url('admin/subjects/edit/' . simple_crypt($s->id)).'"><i class="fas fa-edit"></i></a> |';
					$del_btn = '<a class="btn btn-sm btn-outline-danger" title="Delete" href="'. base_url('admin/subjects/delete/' . simple_crypt($s->id)).'"><i class="fas fa-trash"></i></a>';
